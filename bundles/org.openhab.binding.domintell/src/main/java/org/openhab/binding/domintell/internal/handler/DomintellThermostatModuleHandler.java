...
public class DomintellThermostatModuleHandler extends DomintellModuleHandler {
     ...
     * @param useCelsius Measurement flag: true for C
     */
    public DomintellThermostatModuleHandler(Thing thing, DomintellRegistry registry, boolean useCelsius) {
            ...
            default:
                ...
                if (f != null) {
                    QuantityType<Temperature> temperatureQuantityType = new QuantityType<>(f,
                            useCelsius ? SIUnits.CELSIUS : ImperialUnits.FAHRENHEIT);
